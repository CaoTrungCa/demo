                    ...
                    <div className="h-full flex flex-col justify-between px-3 py-4 overflow-y-auto shadow bg-white">
                        <div>
                            <ul className="space-y-2 font-medium">
                                ...
                                <li onClick={() => handleOptionChange('categories')}>
                                    <div
                                        className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor" className="w-5 h-5 bi bi-tags-fill text-gray-500 group-hover:text-gray-900" viewBox="0 0 16 16">
