        ...
        <div className="">
            ...
            <div className="grid md:grid-cols-5">
                ...
                <div className="md:col-span-3">
                    <div className="cake_and_candle">
                        <div className="flex gap-2 h-14 absolute top-[190px] md:left-[47%] min-[320px]:left-[40%]">
                            <div className="h-full w-8 p-1">
                        ...
                        <svg className="block relative top-0 left-0 right-0 mx-auto -mt-40" version="1.1" x="0px" y="0px" width="290px" height="500px" viewBox="0 0 200 500" enableBackground="new 0 0 200 500" xmlSpace="preserve">
                    ...
                    <div>
                        <button onClick={handleOffFire} className="px-4 py-2 bg-blue-200 text-white rounded-md hover:cursor-pointer">
                            Cầu nguyện và thổi nến online nào!!!
                        </button>
                    </div>
                </div>
            </div>
            {!onFire && <div className="flex fixed top-0 left-0 right-0 bottom-0 z-30 justify-center items-center bg-gray-800 bg-opacity-50">
                <div className="grid md:grid-cols-2">
                    <div className="md:col-span-1 w-96 h-[500px] shadow-md bg-white border-y-4 border-l-4 rounded-l-md">
                        <div className="shadow h-48 w-44 mt-14 ml-24 rounded-lg bg-white" style={{ WebkitTransform: 'rotate(15deg)', transform: 'rotate(15deg)' }}>
                            <Image src="/user/bg_default.jpg" alt="" width={100} height={100}
                                className="h-full w-full rounded-lg pt-8 pb-4 px-4" />
                        </div>
                        <div className="shadow h-48 w-44 ml-24 rounded-lg bg-white" style={{ WebkitTransform: 'rotate(-15deg)', transform: 'rotate(-15deg)' }}>
                            <Image src="/user/bg_default.jpg" alt="" width={100} height={100}
                                className="h-full w-full rounded-lg pt-8 pb-4 px-4" />
                        </div>
                    </div>
                    <div className="md:col-span-1 w-96 h-[500px] shadow-md bg-white border-y-4 border-r-4 rounded-r-md">
